...
module.exports = function (
  ...
  this.getFolderConstraints = utils.memoize(() => {
    ...
    // console.log('fileBrowserConstraintPath', settings.has('fileBrowserConstraintPath'), settings.get('fileBrowserConstraintPath'))
   ...
   */
  this.getPath = () => {
    return this.getFolderConstraints() ? '/' : os.homedir()
  }
}
